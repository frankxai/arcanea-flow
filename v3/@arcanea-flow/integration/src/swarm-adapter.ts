...
// ============================================================================
// V3 Swarm Types (Source Interface from @arcanea-flow/swarm)
// ============================================================================

/**
 * V3 Topology types (from @arcanea-flow/swarm)
 */
export type V3TopologyType = 'mesh' | 'hierarchical' | 'centralized' | 'hybrid';

/**
 * V3 Agent Domain types (from @arcanea-flow/swarm)
 */
export type V3AgentDomain = 'queen' | 'security' | 'core' | 'integration' | 'support';

/**
 * V3 Agent State interface (simplified from @arcanea-flow/swarm)
 */
...
/**
 * V3 Task Definition interface (simplified from @arcanea-flow/swarm)
 */
 ...
 * Usage:
 * ```typescript
 * import { SwarmAdapter, createSwarmAdapter } from '@arcanea-flow/integration';
 *
