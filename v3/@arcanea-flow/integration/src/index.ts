/**
 * @arcanea-flow/integration - V3 Integration Module
 *
 ...
 * Usage:
 * ```typescript
 * import { createAgenticFlowBridge } from '@arcanea-flow/integration';
 *
 ...
 * ```
 *
 * @module @arcanea-flow/integration
...
export const METADATA = {
  name: '@arcanea-flow/integration',
  version: VERSION,
  description: 'Deep agentic-flow@alpha integration for arcanea-flow v3',
  implements: ['ADR-001'],
  features: [
