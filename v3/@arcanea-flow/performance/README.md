...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/performance.svg)](https://www.npmjs.com/package/@arcanea-flow/performance)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/performance.svg)](https://www.npmjs.com/package/@arcanea-flow/performance)
...
```bash
npm install @arcanea-flow/performance
```
...
```typescript
import { benchmark } from '@arcanea-flow/performance';
...
- [@arcanea-flow/memory](../memory) - Memory operations to benchmark
- [@arcanea-flow/swarm](../swarm) - Swarm coordination to benchmark
- [@arcanea-flow/neural](../neural) - Neural operations to benchmark
