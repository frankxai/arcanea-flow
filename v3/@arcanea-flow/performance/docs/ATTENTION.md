...
```typescript
import { createFlashAttentionOptimizer } from '@arcanea-flow/performance';
...
```typescript
import { quickBenchmark } from '@arcanea-flow/performance';
...
```typescript
import { quickValidation } from '@arcanea-flow/performance';
...
```typescript
import { runAndDisplaySuite } from '@arcanea-flow/performance';
...
```bash
# Run all examples
npx tsx v3/@arcanea-flow/performance/src/examples/flash-attention-demo.ts
```
...
```typescript
import { FlashAttentionOptimizer } from '@arcanea-flow/performance';
