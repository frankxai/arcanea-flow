...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/security.svg)](https://www.npmjs.com/package/@arcanea-flow/security)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/security.svg)](https://www.npmjs.com/package/@arcanea-flow/security)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Security Audit](https://img.shields.io/badge/Security-Audited-green.svg)](https://github.com/ruvnet/arcanea-flow)
...
```bash
npm install @arcanea-flow/security
```

## Quick Start

```typescript
import { createSecurityModule } from '@arcanea-flow/security';
...
```typescript
import { PasswordHasher, createPasswordHasher } from '@arcanea-flow/security';
...
```typescript
import { CredentialGenerator, generateCredentials } from '@arcanea-flow/security';
...
```typescript
import { SafeExecutor, createDevelopmentExecutor } from '@arcanea-flow/security';
...
```typescript
import { PathValidator, createProjectPathValidator } from '@arcanea-flow/security';
...
// Sanitize HTML
import { sanitizeHtml } from '@arcanea-flow/security';
...
```typescript
import { TokenGenerator, quickGenerate } from '@arcanea-flow/security';
...
```typescript
import { auditSecurityConfig } from '@arcanea-flow/security';
...
- [@arcanea-flow/shared](../shared) - Shared types and utilities
- [@arcanea-flow/swarm](../swarm) - Swarm coordination (secure agent spawning)
