...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/embeddings.svg)](https://www.npmjs.com/package/@arcanea-flow/embeddings)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/embeddings.svg)](https://www.npmjs.com/package/@arcanea-flow/embeddings)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Performance](https://img.shields.io/badge/Performance-<5ms-brightgreen.svg)](https://github.com/ruvnet/arcanea-flow)
...
```bash
npm install @arcanea-flow/embeddings
```
...
arcanea-flow embeddings init --provider agentic-flow
```
...
```typescript
import { OpenAIEmbeddingService } from '@arcanea-flow/embeddings';
...
```typescript
import { AgenticFlowEmbeddingService } from '@arcanea-flow/embeddings';
...
```typescript
import { TransformersEmbeddingService } from '@arcanea-flow/embeddings';
...
```typescript
import { MockEmbeddingService } from '@arcanea-flow/embeddings';
...
```typescript
import { createEmbeddingService } from '@arcanea-flow/embeddings';
...
```typescript
import { chunkText, estimateTokens, reconstructFromChunks } from '@arcanea-flow/embeddings';
...
```typescript
import { PersistentEmbeddingCache, isPersistentCacheAvailable } from '@arcanea-flow/embeddings';
...
# Neural operations
arcanea-flow embeddings neural drift --baseline "context" --input "check this"
...
- [@arcanea-flow/memory](../memory) - HNSW indexing and vector storage
- [@arcanea-flow/providers](../providers) - Multi-LLM provider system
- [@arcanea-flow/neural](../neural) - SONA learning integration
