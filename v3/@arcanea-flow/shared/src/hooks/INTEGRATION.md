...
```typescript
import { createEventBus } from '@arcanea-flow/shared/core';
import { createHookRegistry, createHookExecutor } from '@arcanea-flow/shared/hooks';
import { EventStore } from '@arcanea-flow/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@arcanea-flow/shared/hooks';
...
import { Plugin } from '@arcanea-flow/shared';
import { HookEvent, HookPriority } from '@arcanea-flow/shared/hooks';
...
```typescript
// v3/@arcanea-flow/shared/src/mcp/tools/hooks.ts
