...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/shared.svg)](https://www.npmjs.com/package/@arcanea-flow/shared)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/shared.svg)](https://www.npmjs.com/package/@arcanea-flow/shared)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Core](https://img.shields.io/badge/Module-Core-blue.svg)](https://github.com/ruvnet/arcanea-flow)

> Shared utilities, types, and core infrastructure for Claude Flow V3 - the foundation module used by all other @arcanea-flow packages.
...
```bash
npm install @arcanea-flow/shared
```
...
import { ... } from '@arcanea-flow/shared';

// Submodule exports (for tree-shaking or specific imports)
import { ... } from '@arcanea-flow/shared/types';      // Type definitions
import { ... } from '@arcanea-flow/shared/core';       // Config, interfaces, orchestrator
import { ... } from '@arcanea-flow/shared/events';     // Event sourcing (ADR-007)
import { ... } from '@arcanea-flow/shared/hooks';      // Hooks system
import { ... } from '@arcanea-flow/shared/mcp';        // MCP server infrastructure
import { ... } from '@arcanea-flow/shared/security';   // Security utilities
import { ... } from '@arcanea-flow/shared/resilience'; // Retry, circuit breaker, rate limiter
```
...
import type {
  ...
  MCPRequest,
  MCPResponse
} from '@arcanea-flow/shared/types';
```
...
```typescript
import { EventBus, EventCoordinator } from '@arcanea-flow/shared/events';
...
```typescript
import { HooksManager, Hook } from '@arcanea-flow/shared/hooks';
...
```typescript
import { HealthMonitor, HealthCheck } from '@arcanea-flow/shared/core';
...
This package is a dependency of all other @arcanea-flow modules:

- [@arcanea-flow/cli](../cli) - CLI module
- [@arcanea-flow/security](../security) - Security & validation
- [@arcanea-flow/memory](../memory) - AgentDB & HNSW indexing
- [@arcanea-flow/neural](../neural) - SONA learning & RL algorithms
- [@arcanea-flow/performance](../performance) - Benchmarking & optimization
- [@arcanea-flow/swarm](../swarm) - 15-agent coordination
- [@arcanea-flow/integration](../integration) - agentic-flow@alpha bridge
- [@arcanea-flow/testing](../testing) - TDD framework & fixtures
- [@arcanea-flow/deployment](../deployment) - Release management
- [@arcanea-flow/embeddings](../embeddings) - Embedding service
- [@arcanea-flow/hooks](../hooks) - Hooks system
