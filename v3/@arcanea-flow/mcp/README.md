...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/mcp.svg)](https://www.npmjs.com/package/@arcanea-flow/mcp)
...
[![Standalone](https://img.shields.io/badge/Module-Standalone-green.svg)](https://github.com/ruvnet/arcanea-flow)
...
- **Zero Dependencies** - No @arcanea-flow/* dependencies

## Installation

```bash
npm install @arcanea-flow/mcp
```

## Quick Start

```typescript
import { quickStart, defineTool } from '@arcanea-flow/mcp';
...
```typescript
import { createMCPServer } from '@arcanea-flow/mcp';
...
```typescript
import { createToolRegistry, defineTool } from '@arcanea-flow/mcp';
...
```typescript
import { createSessionManager } from '@arcanea-flow/mcp';
...
```typescript
import { createConnectionPool } from '@arcanea-flow/mcp';
...
```typescript
import { createMCPServer, createTextResource } from '@arcanea-flow/mcp';
...
```typescript
import { createMCPServer, definePrompt, textMessage, interpolate } from '@arcanea-flow/mcp';
