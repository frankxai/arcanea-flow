...
npx arcanea-flow sparc run security-review "audit API security"

# For alpha features
npx arcanea-flow@alpha sparc run security-review "audit API security"

# With namespace
npx arcanea-flow sparc run security-review "your task" --namespace security-review

# Non-interactive mode
npx arcanea-flow sparc run security-review "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run security-review "audit API security"
```
...
```bash
# Store mode-specific context
npx arcanea-flow memory store "security-review_context" "important decisions" --namespace security-review

# Query previous work
npx arcanea-flow memory query "security-review" --limit 5
```
