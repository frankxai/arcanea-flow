...
npx arcanea-flow sparc run designer "create dashboard UI"

# For alpha features
npx arcanea-flow@alpha sparc run designer "create dashboard UI"
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run designer "create dashboard UI"
```
