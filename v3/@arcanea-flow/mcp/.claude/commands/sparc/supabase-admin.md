...
npx arcanea-flow sparc run supabase-admin "create user authentication schema"

# For alpha features
npx arcanea-flow@alpha sparc run supabase-admin "create user authentication schema"

# With namespace
npx arcanea-flow sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx arcanea-flow sparc run supabase-admin "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run supabase-admin "create user authentication schema"
```
...
```bash
# Store mode-specific context
npx arcanea-flow memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx arcanea-flow memory query "supabase-admin" --limit 5
```
