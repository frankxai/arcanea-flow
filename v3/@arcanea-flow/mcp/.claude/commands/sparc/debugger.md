...
npx arcanea-flow sparc run debugger "fix authentication issues"

# For alpha features
npx arcanea-flow@alpha sparc run debugger "fix authentication issues"
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run debugger "fix authentication issues"
```
