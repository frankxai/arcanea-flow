...
npx arcanea-flow sparc run analyzer "analyze codebase performance"

# For alpha features
npx arcanea-flow@alpha sparc run analyzer "analyze codebase performance"
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run analyzer "analyze codebase performance"
```
