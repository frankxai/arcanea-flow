...
npx arcanea-flow sparc run memory-manager "organize project knowledge"

# For alpha features
npx arcanea-flow@alpha sparc run memory-manager "organize project knowledge"
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run memory-manager "organize project knowledge"
```
