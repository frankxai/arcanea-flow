...
npx arcanea-flow sparc run tdd "shopping cart feature"

# For alpha features
npx arcanea-flow@alpha sparc run tdd "shopping cart feature"
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run tdd "shopping cart feature"
```
