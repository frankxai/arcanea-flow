...
npx arcanea-flow sparc run innovator "innovative solutions for scaling"

# For alpha features
npx arcanea-flow@alpha sparc run innovator "innovative solutions for scaling"
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run innovator "innovative solutions for scaling"
```
