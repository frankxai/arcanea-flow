...
description: "CLI modernization and hooks system enhancement for arcanea-flow v3. Implements interactive prompts, command decomposition, enhanced hooks integration, and intelligent workflow automation."
---
...
Modernizes arcanea-flow v3 CLI with interactive prompts, intelligent command decomposition, enhanced hooks integration, performance optimization, and comprehensive workflow automation capabilities.
...
arcanea-flow swarm init --interactive
arcanea-flow learning start --guided
arcanea-flow workflow create --from-intent "setup new project"
```