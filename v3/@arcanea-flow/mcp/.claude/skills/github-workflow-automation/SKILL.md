...
```bash
# Usage example
npx arcanea-flow@alpha github gh-coordinator \
...
npx arcanea-flow@alpha github issue-tracker \
...
npx arcanea-flow@alpha github release-manager \
...
npx arcanea-flow@alpha github repo-architect \
...
npx arcanea-flow@alpha github ci-orchestrator \
...
mcp__arcanea-flow__agent_spawn { type: "coordinator", name: "GitHub Coordinator" }
mcp__arcanea-flow__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__arcanea-flow__agent_spawn { type: "tester", name: "QA Agent" }
mcp__arcanea-flow__agent_spawn { type: "analyst", name: "Security Analyst" }
...
npx arcanea-flow@alpha github sync-coordinator \
...
- [ ] `arcanea-flow@alpha` package available
...
- **Claude-Flow**: https://github.com/ruvnet/arcanea-flow
