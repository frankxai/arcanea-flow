...
hooks:
  pre: |
    ...
    mcp__arcanea-flow__swarm_init hierarchical --maxAgents=10 --strategy=adaptive
    # Store coordination state
    mcp__arcanea-flow__memory_usage store "swarm:hierarchy:${TASK_ID}" "$(date): Hierarchical coordination started" --namespace=swarm
    # Set up monitoring
    mcp__arcanea-flow__swarm_monitor --interval=5000 --swarmId="${SWARM_ID}"
  post: |
    echo "✨ Hierarchical coordination complete"
    # Generate performance report
    mcp__arcanea-flow__performance_report --format=detailed --timeframe=24h
    # Store completion metrics
    mcp__arcanea-flow__memory_usage store "swarm:hierarchy:${TASK_ID}:complete" "$(date): Task completed with $(mcp__arcanea-flow__swarm_status | jq '.agents.total') agents"
    # Cleanup resources
...
- **Spawn Command**: `mcp__arcanea-flow__agent_spawn researcher --capabilities="research,analysis,information_gathering"`

### Code Workers 💻  
- **Capabilities**: Implementation, code review, testing, documentation
- **Use Cases**: Feature development, bug fixes, code optimization
- **Spawn Command**: `mcp__arcanea-flow__agent_spawn coder --capabilities="code_generation,testing,optimization"`

### Analyst Workers 📊
- **Capabilities**: Data analysis, performance monitoring, reporting
- **Use Cases**: Metrics analysis, performance optimization, reporting
- **Spawn Command**: `mcp__arcanea-flow__agent_spawn analyst --capabilities="data_analysis,performance_monitoring,reporting"`

### Test Workers 🧪
- **Capabilities**: Quality assurance, validation, compliance checking
- **Use Cases**: Testing, validation, quality gates
- **Spawn Command**: `mcp__arcanea-flow__agent_spawn tester --capabilities="testing,validation,quality_assurance"`
...
mcp__arcanea-flow__swarm_init hierarchical --maxAgents=10 --strategy=centralized

# Spawn specialized workers
mcp__arcanea-flow__agent_spawn researcher --capabilities="research,analysis"
mcp__arcanea-flow__agent_spawn coder --capabilities="implementation,testing"
mcp__arcanea-flow__agent_spawn analyst --capabilities="data_analysis,reporting"
...
mcp__arcanea-flow__task_orchestrate "Build authentication service" --strategy=sequential --priority=high

# Load balance across workers
mcp__arcanea-flow__load_balance --tasks="auth_api,auth_tests,auth_docs" --strategy=capability_based

# Sync coordination state
mcp__arcanea-flow__coordination_sync --namespace=hierarchy
```
...
# Analyze bottlenecks
mcp__arcanea-flow__bottleneck_analyze --component=coordination --metrics="throughput,latency,success_rate"

# Monitor resource usage
mcp__arcanea-flow__metrics_collect --components="agents,tasks,coordination"
```
