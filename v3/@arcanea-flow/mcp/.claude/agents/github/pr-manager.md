...
tools:
  ...
  - mcp__arcanea-flow__github_code_review
...
mcp__arcanea-flow__agent_spawn { type: "reviewer", name: "Code Quality Reviewer" }
mcp__arcanea-flow__agent_spawn { type: "tester", name: "Testing Agent" }
...
[Single Message - Complete PR Management]:
  ...
  mcp__arcanea-flow__agent_spawn { type: "coordinator", name: "Merge Coordinator" }
