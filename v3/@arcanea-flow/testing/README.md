...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/testing.svg)](https://www.npmjs.com/package/@arcanea-flow/testing)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/testing.svg)](https://www.npmjs.com/package/@arcanea-flow/testing)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![TDD](https://img.shields.io/badge/TDD-London%20School-purple.svg)](https://github.com/ruvnet/arcanea-flow)
...
```bash
npm install @arcanea-flow/testing vitest --save-dev
```
...
```typescript
import { createMockClock, measureTime } from '@arcanea-flow/testing';
...
```typescript
import { createTestEmitter } from '@arcanea-flow/testing';
...
```typescript
import { MockAgentDB } from '@arcanea-flow/testing';
...
```typescript
import { MockSwarmCoordinator } from '@arcanea-flow/testing';
...
```typescript
import { MockMCPClient, createStandardMockMCPClient } from '@arcanea-flow/testing';
...
```typescript
import { registerCustomMatchers } from '@arcanea-flow/testing';
...
```typescript
import { setupV3Tests, configureTestEnvironment } from '@arcanea-flow/testing';
...
```typescript
import { createSetupContext, createTestScope } from '@arcanea-flow/testing';
...
```typescript
import { createPerformanceTestHelper } from '@arcanea-flow/testing';
...
```typescript
import { assertV3PerformanceTargets, TEST_CONFIG } from '@arcanea-flow/testing';
