...
export class IntegrationRegressionSuite {
  ...
  private registerDefaultTests(): void {
    ...
    this.tests.push({
      ...
      timeout: 5000,
      run: async () => {
        const { UnifiedMemoryService, HybridBackend } = await import('@arcanea-flow/memory');
    ...
    this.tests.push({
      ...
      timeout: 10000,
      run: async () => {
        const { HybridBackend, UnifiedMemoryService } = await import('@arcanea-flow/memory');
    ...
    this.tests.push({
      ...
      timeout: 5000,
      run: async () => {
        const { EventBus, createAgentSpawnedEvent } = await import('@arcanea-flow/shared');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const { UnifiedSwarmCoordinator } = await import('@arcanea-flow/swarm');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const { HookRegistry, HookPriority } = await import('@arcanea-flow/shared');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          ...
          const shared = await import('@arcanea-flow/shared');
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const memory = await import('@arcanea-flow/memory');
          return (
    ...
    this.tests.push({
      ...
      run: async () => {
        try {
          const swarm = await import('@arcanea-flow/swarm');
