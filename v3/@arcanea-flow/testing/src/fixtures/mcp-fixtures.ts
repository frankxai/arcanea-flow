/**
 * @arcanea-flow/testing - MCP Fixtures
 *
...
export const mcpResources: Record<string, MCPResource> = {
  ...
  agentRegistry: {
    uri: 'arcanea-flow://agents/registry',
    name: 'Agent Registry',
  ...
  learningPatterns: {
    uri: 'arcanea-flow://neural/patterns',
