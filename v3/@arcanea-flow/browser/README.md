# @arcanea-flow/browser

<div align="center">

[![npm version](https://img.shields.io/npm/v/@arcanea-flow/browser?style=for-the-badge&logo=npm&color=blue)](https://www.npmjs.com/package/@arcanea-flow/browser)
...
*Integrate [agent-browser](https://github.com/AugmentCode/agent-browser) with arcanea-flow for intelligent web automation, trajectory learning, security scanning, and multi-agent browser coordination.*
...
`@arcanea-flow/browser` provides a comprehensive browser automation layer for AI agents, combining Vercel Labs' `agent-browser` CLI with arcanea-flow's learning, memory, and security capabilities. It enables agents to navigate websites, fill forms, extract data, and learn from successful interaction patterns.
...
npm install @arcanea-flow/cli@^3.0.0-alpha
...
```typescript
import { createBrowserService, browserTools } from '@arcanea-flow/browser';
...
Register browser tools with arcanea-flow's MCP server:

```typescript
import { browserTools } from '@arcanea-flow/browser';
...
```typescript
import { createMemoryManager } from '@arcanea-flow/browser';
...
```typescript
import { listWorkflows, getWorkflow, getWorkflowManager } from '@arcanea-flow/browser';
...
```typescript
import { preBrowseHook, postBrowseHook, browserHooks } from '@arcanea-flow/browser';
...
```typescript
import { createBrowserSwarm } from '@arcanea-flow/browser';
...
```typescript
import { createBrowserService, getSecurityScanner } from '@arcanea-flow/browser';
...
- [Claude-Flow Documentation](https://github.com/ruvnet/arcanea-flow#readme)
...
**Part of the [Claude-Flow](https://github.com/ruvnet/arcanea-flow) ecosystem**
