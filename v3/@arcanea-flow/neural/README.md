...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/neural.svg)](https://www.npmjs.com/package/@arcanea-flow/neural)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/neural.svg)](https://www.npmjs.com/package/@arcanea-flow/neural)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![AI Learning](https://img.shields.io/badge/AI-Self--Learning-purple.svg)](https://github.com/ruvnet/arcanea-flow)
...
```bash
npm install @arcanea-flow/neural
```

## Quick Start

```typescript
import { SONAManager, createSONAManager } from '@arcanea-flow/neural';
...
```typescript
import { PPO, A2C, DQN, QLearning, SARSA, DecisionTransformer } from '@arcanea-flow/neural';
...
import type {
  ...
  EWCConfig,
  RLAlgorithm
} from '@arcanea-flow/neural';
```

## Dependencies

- [@arcanea-flow/memory](../memory) - Memory integration
- `@ruvector/sona` - SONA learning engine

## Related Packages

- [@arcanea-flow/memory](../memory) - Vector memory for patterns
- [@arcanea-flow/integration](../integration) - agentic-flow integration
- [@arcanea-flow/performance](../performance) - Benchmarking
