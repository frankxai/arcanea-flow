...
```typescript
import { createSONALearningEngine, getModeConfig } from '@arcanea-flow/neural';
...
**Location**: `/workspaces/arcanea-flow/v3/@arcanea-flow/neural/`
