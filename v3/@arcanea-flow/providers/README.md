...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/providers.svg)](https://www.npmjs.com/package/@arcanea-flow/providers)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/providers.svg)](https://www.npmjs.com/package/@arcanea-flow/providers)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Providers](https://img.shields.io/badge/Providers-6+-orange.svg)](https://github.com/ruvnet/arcanea-flow)
...
```bash
npm install @arcanea-flow/providers
```

## Quick Start

```typescript
import { createProviderManager } from '@arcanea-flow/providers';
...
```typescript
import { ProviderManager, createProviderManager } from '@arcanea-flow/providers';
...
```typescript
import { createProviderManager } from '@arcanea-flow/providers';
import { createUnifiedSwarmCoordinator } from '@arcanea-flow/swarm';
...
- [@arcanea-flow/embeddings](../embeddings) - Embedding generation
- [@arcanea-flow/memory](../memory) - Vector storage and retrieval
