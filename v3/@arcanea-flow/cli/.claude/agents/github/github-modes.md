...
tools: mcp__arcanea-flow__swarm_init, mcp__arcanea-flow__agent_spawn, mcp__arcanea-flow__task_orchestrate, Bash, TodoWrite, Read, Write
color: purple
type: development
capabilities:
...
mcp__arcanea-flow__task_orchestrate { task: "GitHub workflow", strategy: "parallel" }
```