...
mcp__flow-nexus__execution_stream_subscribe({
  stream_type: "arcanea-flow-swarm", // claude-code, arcanea-flow-swarm, arcanea-flow-hive-mind, github-integration
...
mcp__flow-nexus__execution_files_list({
  stream_id: "stream_id",
  created_by: "arcanea-flow", // claude-code, arcanea-flow, git-clone, user
