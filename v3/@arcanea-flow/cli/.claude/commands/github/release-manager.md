...
mcp__arcanea-flow__agent_spawn { type: "coordinator", name: "Release Coordinator" }
...
[Single Message - Complete Release Management]:
  ...
  mcp__arcanea-flow__swarm_init { topology: "star", maxAgents: 8 }
  mcp__arcanea-flow__agent_spawn { type: "coordinator", name: "Release Director" }
  mcp__arcanea-flow__agent_spawn { type: "tester", name: "QA Lead" }
  mcp__arcanea-flow__agent_spawn { type: "reviewer", name: "Senior Reviewer" }
  mcp__arcanea-flow__agent_spawn { type: "coder", name: "Version Controller" }
  mcp__arcanea-flow__agent_spawn { type: "analyst", name: "Performance Analyst" }
  ...
  mcp__arcanea-flow__memory_usage {
    ...
    value: {
      ...
      packages: ["arcanea-flow", "ruv-swarm"],
  ...
  release-validation:
    ...
    steps:
      ...
      - name: Validate Release
        run: npx arcanea-flow release validate
```
