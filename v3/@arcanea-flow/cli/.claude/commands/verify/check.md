...
```bash
arcanea-flow verify check [options]
```
...
arcanea-flow verify check --file src/critical.js --threshold 0.99

# Verify and auto-fix issues
arcanea-flow verify check --directory src/ --auto-fix

# Get JSON output for CI/CD
arcanea-flow verify check --json > verification.json
```
