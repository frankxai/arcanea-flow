...
npx arcanea-flow sparc run code "implement REST API endpoints"

# For alpha features
npx arcanea-flow@alpha sparc run code "implement REST API endpoints"

# With namespace
npx arcanea-flow sparc run code "your task" --namespace code

# Non-interactive mode
npx arcanea-flow sparc run code "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run code "implement REST API endpoints"
```
...
```bash
# Store mode-specific context
npx arcanea-flow memory store "code_context" "important decisions" --namespace code

# Query previous work
npx arcanea-flow memory query "code" --limit 5
```
