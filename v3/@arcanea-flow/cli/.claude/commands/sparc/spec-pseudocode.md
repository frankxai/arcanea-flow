...
npx arcanea-flow sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx arcanea-flow@alpha sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx arcanea-flow sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx arcanea-flow sparc run spec-pseudocode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run spec-pseudocode "define payment flow requirements"
```
...
```bash
# Store mode-specific context
npx arcanea-flow memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx arcanea-flow memory query "spec-pseudocode" --limit 5
```
