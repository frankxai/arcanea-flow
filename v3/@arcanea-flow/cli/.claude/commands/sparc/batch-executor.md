...
npx arcanea-flow sparc run batch-executor "process multiple files"

# For alpha features
npx arcanea-flow@alpha sparc run batch-executor "process multiple files"
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run batch-executor "process multiple files"
```
