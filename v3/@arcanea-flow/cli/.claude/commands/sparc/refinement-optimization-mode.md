...
npx arcanea-flow sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx arcanea-flow@alpha sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx arcanea-flow sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx arcanea-flow sparc run refinement-optimization-mode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run refinement-optimization-mode "optimize database queries"
```
...
```bash
# Store mode-specific context
npx arcanea-flow memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx arcanea-flow memory query "refinement-optimization-mode" --limit 5
```
