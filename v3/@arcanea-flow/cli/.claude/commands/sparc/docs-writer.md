...
npx arcanea-flow sparc run docs-writer "create API documentation"

# For alpha features
npx arcanea-flow@alpha sparc run docs-writer "create API documentation"

# With namespace
npx arcanea-flow sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
npx arcanea-flow sparc run docs-writer "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If arcanea-flow is installed locally
./arcanea-flow sparc run docs-writer "create API documentation"
```
...
```bash
# Store mode-specific context
npx arcanea-flow memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
npx arcanea-flow memory query "docs-writer" --limit 5
```
