...
### Swarm Tools
```
hierarchical-coordinator: mcp__arcanea-flow__swarm_*, mcp__arcanea-flow__agent_*
mesh-coordinator: mcp__arcanea-flow__swarm_*, mcp__arcanea-flow__coordination_*
adaptive-coordinator: mcp__arcanea-flow__topology_*, mcp__arcanea-flow__swarm_*
```

### GitHub Tools
```
pr-manager: mcp__github__*, Bash (gh CLI)
code-review-swarm: mcp__github__*, mcp__arcanea-flow__swarm_*
release-manager: mcp__github__*, mcp__arcanea-flow__workflow_*
```
...
npx arcanea-flow agent spawn -t coder --help
