...
```bash
arcanea-flow pair --list
```

### Switch Between Sessions
```bash
arcanea-flow pair --switch <session-id>
```

### Merge Sessions
```bash
arcanea-flow pair --merge <session-1> <session-2>
```
...
### Manual Recovery
```bash
arcanea-flow pair --recover [--point <timestamp>]
```

### Crash Recovery
```bash
arcanea-flow pair --crash-recovery
```
...
### Share with Team
```bash
arcanea-flow pair --share <session-id> \
  --team <team-id>
```

### Export for Review
```bash
arcanea-flow pair --export-review <session-id>
```

### Create Learning Material
```bash
arcanea-flow pair --create-tutorial <session-id>
```
