...
Main configuration file: `.arcanea-flow/pair-config.json`
...
arcanea-flow pair config reset verification
```
...
### Project-Specific
`.arcanea-flow/pair-config.json` in project root

### User-Specific
`~/.arcanea-flow/pair-config.json`

### Global
`/etc/arcanea-flow/pair-config.json`
...
arcanea-flow pair config validate

# Test configuration
arcanea-flow pair config test
```
...
### From Version 1.x
```bash
arcanea-flow pair config migrate --from 1.x
```

### Export/Import
```bash
# Export current config
arcanea-flow pair config export > my-config.json

# Import config
arcanea-flow pair config import my-config.json
```
