...
```
Tool: mcp__arcanea-flow__swarm_init
...
```
Tool: mcp__arcanea-flow__agent_spawn
Parameters: {
  "type": "architect",
  "name": "System Design",
...
```
Tool: mcp__arcanea-flow__task_orchestrate
Parameters: {
...
### 4. Monitor Progress
```
Tool: mcp__arcanea-flow__task_status
...
npx arcanea-flow workflow dev "REST API with auth"

# Create custom workflow
npx arcanea-flow workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx arcanea-flow workflow execute api-dev
```