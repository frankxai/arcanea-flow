...
export const DEFAULT_PLUGIN_STORE_CONFIG: PluginStoreConfig = {
  ...
  defaultRegistry: 'arcanea-flow-official',
  gateway: 'https://ipfs.io',
  timeout: 30000,
  cacheDir: '.arcanea-flow/plugins/cache',
...
export class PluginDiscoveryService {
  ...
  private createDemoRegistry(registry: KnownPluginRegistry): PluginDiscoveryResult {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalAuthors: 2,
      featured: ['@arcanea-flow/neural', '@arcanea-flow/security', 'plugin-creator'],
      trending: ['@arcanea-flow/embeddings', 'plugin-creator', 'community-analytics'],
      newest: ['custom-agents', 'slack-integration', 'plugin-creator'],
      official: ['@arcanea-flow/neural', '@arcanea-flow/security', '@arcanea-flow/embeddings', '@arcanea-flow/claims', '@arcanea-flow/performance', 'plugin-creator'],
      compatibilityMatrix: [
        { pluginId: '@arcanea-flow/neural', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
        { pluginId: '@arcanea-flow/security', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
      ],
    };
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      {
        id: '@arcanea-flow/neural',
        name: '@arcanea-flow/neural',
        ...
        dependencies: [{ name: '@arcanea-flow/core', version: '^3.0.0' }],
        type: 'core',
      ...
      },
      {
        ...
        trustLevel: 'official',
        securityAudit: {
          auditor: 'arcanea-flow-security-team',
      ...
      {
        id: '@arcanea-flow/embeddings',
        name: '@arcanea-flow/embeddings',
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [
          { name: '@arcanea-flow/core', version: '^3.0.0' },
      ...
      {
        id: '@arcanea-flow/claims',
        name: '@arcanea-flow/claims',
      ...
      {
        id: '@arcanea-flow/performance',
        name: '@arcanea-flow/performance',
