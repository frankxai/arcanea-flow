...
async function demo() {
  ...
  if (pluginCreator) {
    ...
    console.log('   $ arcanea-flow plugins install -n plugin-creator');
    console.log('');
  }
  ...
  console.log('   $ arcanea-flow plugins list              # List all plugins');
  console.log('   $ arcanea-flow plugins list --official   # Official only');
  console.log('   $ arcanea-flow plugins search -q neural  # Search plugins');
  console.log('   $ arcanea-flow plugins info -n plugin-creator');
  console.log('   $ arcanea-flow plugins install -n plugin-creator');
  console.log('');
}
