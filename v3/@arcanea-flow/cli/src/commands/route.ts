...
const routeTaskCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route task "implement authentication"', description: 'Route task to best agent' },
    { command: 'arcanea-flow route task "write unit tests" --q-learning', description: 'Use Q-Learning routing' },
    { command: 'arcanea-flow route task "review code" --agent reviewer', description: 'Force specific agent' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!taskDescription) {
      ...
      output.writeln(output.dim('Usage: arcanea-flow route task "task description"'));
...
const listAgentsCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route list-agents', description: 'List all agents' },
    { command: 'arcanea-flow route agents --json', description: 'List agents as JSON' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const jsonOutput = ctx.flags.json as boolean;
...
const statsCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route stats', description: 'Show routing statistics' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const jsonOutput = ctx.flags.json as boolean;
...
const feedbackCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route feedback -t "implement auth" -a coder -r 0.9', description: 'Positive feedback' },
    { command: 'arcanea-flow route feedback -t "write tests" -a tester -r -0.5', description: 'Negative feedback' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const resetCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route reset', description: 'Reset router state' },
    { command: 'arcanea-flow route reset --force', description: 'Force reset' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const exportCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route export', description: 'Export Q-table to stdout' },
    { command: 'arcanea-flow route export -f qtable.json', description: 'Export to file' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const importCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route import -f qtable.json', description: 'Import Q-table from file' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const coverageRouteCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route coverage', description: 'Analyze coverage and suggest routing' },
    { command: 'arcanea-flow route coverage --suggest', description: 'Get improvement suggestions' },
    { command: 'arcanea-flow route coverage --gaps', description: 'List coverage gaps by agent' },
    { command: 'arcanea-flow route coverage -p src/auth -t 90', description: 'Analyze specific path with threshold' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const routeCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow route "implement feature"', description: 'Route task to best agent' },
    { command: 'arcanea-flow route "write tests" --q-learning', description: 'Use Q-Learning routing' },
    { command: 'arcanea-flow route --agent coder "fix bug"', description: 'Force specific agent' },
    { command: 'arcanea-flow route list-agents', description: 'List available agents' },
    { command: 'arcanea-flow route stats', description: 'Show routing statistics' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln('Usage: arcanea-flow route <task> [options]');
    output.writeln('       arcanea-flow route <subcommand>');
    output.writeln();
    ...
    output.writeln(output.dim('Run "arcanea-flow route <subcommand> --help" for more info'));
