...
const benchmarkCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow performance benchmark -s neural', description: 'Benchmark neural operations' },
    { command: 'arcanea-flow performance benchmark -i 1000', description: 'Run with 1000 iterations' },
  ],
...
const profileCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow performance profile -t cpu', description: 'Profile CPU usage' },
    { command: 'arcanea-flow performance profile -d 60', description: 'Profile for 60 seconds' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const metricsCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow performance metrics -t 7d', description: 'Show 7-day metrics' },
    { command: 'arcanea-flow performance metrics -f prometheus', description: 'Export as Prometheus format' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const optimizeCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow performance optimize -t memory', description: 'Optimize memory usage' },
    { command: 'arcanea-flow performance optimize --apply', description: 'Apply all optimizations' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const bottleneckCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow performance bottleneck', description: 'Find bottlenecks' },
    { command: 'arcanea-flow performance bottleneck -d full', description: 'Full analysis' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    output.writeln();
...
export const performanceCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow performance benchmark', description: 'Run benchmarks' },
    { command: 'arcanea-flow performance profile', description: 'Profile application' },
    { command: 'arcanea-flow perf metrics', description: 'View metrics (alias)' },
  ],
