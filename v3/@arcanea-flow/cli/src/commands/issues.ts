...
export const issuesCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow issues list', description: 'List all claims' },
    { command: 'arcanea-flow issues claim 123 --agent coder:coder-1', description: 'Claim as agent' },
    { command: 'arcanea-flow issues handoff 123 --to agent:tester:tester-1', description: 'Handoff to tester' },
    { command: 'arcanea-flow issues stealable', description: 'List stealable' },
    { command: 'arcanea-flow issues steal 123 --agent coder:coder-2', description: 'Steal issue' },
    { command: 'arcanea-flow issues board', description: 'Visual board' },
  ],
