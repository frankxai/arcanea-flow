 ...
 *   npx arcanea-flow ruvector setup --output /path/to/dir
 *   npx arcanea-flow ruvector setup --print      # Print to stdout only
 *
...
services:
  postgres:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: arcanea-flow-test
  ...
  pgadmin:
    ...
    environment:
      PGADMIN_DEFAULT_EMAIL: admin@arcanea-flow.local
...
npx arcanea-flow memory list --format json > memory-export.json
...
export const setupCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow ruvector setup', description: 'Output files to ./ruvector-postgres/' },
    { command: 'arcanea-flow ruvector setup --output /path/to/dir', description: 'Output to custom directory' },
    { command: 'arcanea-flow ruvector setup --print', description: 'Print files to stdout' },
    { command: 'arcanea-flow ruvector setup --force', description: 'Overwrite existing files' },
  ],
