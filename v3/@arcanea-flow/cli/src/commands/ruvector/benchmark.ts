...
export const benchmarkCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow ruvector benchmark', description: 'Run default benchmark' },
    { command: 'arcanea-flow ruvector benchmark --vectors 50000', description: 'Benchmark with 50k vectors' },
    { command: 'arcanea-flow ruvector benchmark --index ivfflat', description: 'Test IVFFlat index' },
    { command: 'arcanea-flow ruvector benchmark --dimensions 768 --metric l2', description: 'Custom dimensions and metric' },
  ],
