...
loadedCommands.set('ao', aoCommand);
...
export { default as aoCommand } from './ao.js';
...
export async function getAoCommand() { return loadCommand('ao'); }
