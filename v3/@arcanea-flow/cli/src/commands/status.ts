...
export const statusCommand: Command = {
  ...
  examples: [
    { command: 'arcanea-flow status', description: 'Show current system status' },
    { command: 'arcanea-flow status --watch', description: 'Watch mode with live updates' },
    { command: 'arcanea-flow status --watch -i 5', description: 'Watch mode updating every 5 seconds' },
    { command: 'arcanea-flow status --health-check', description: 'Run health checks' },
    { command: 'arcanea-flow status --json', description: 'Output status as JSON' },
    { command: 'arcanea-flow status agents', description: 'Show detailed agent status' },
    { command: 'arcanea-flow status tasks', description: 'Show detailed task status' },
    { command: 'arcanea-flow status memory', description: 'Show detailed memory status' }
  ],
  action: statusAction
};
