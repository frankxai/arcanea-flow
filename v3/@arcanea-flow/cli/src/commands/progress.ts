 ...
 *
 * @module @arcanea-flow/cli/commands/progress
 */
...
export const progressCommand: Command = {
  ...
  examples: [
    {
      command: 'arcanea-flow progress',
      description: 'Check current progress',
    },
    {
      command: 'arcanea-flow progress --detailed',
      description: 'Show detailed breakdown',
    },
    {
      command: 'arcanea-flow progress sync',
      description: 'Sync and persist progress',
    },
    {
      command: 'arcanea-flow progress watch',
      description: 'Watch for changes',
    },
    {
      command: 'arcanea-flow progress --json',
