...
// Known compatibility matrix between @arcanea-flow packages
const COMPATIBILITY_MATRIX: Record<string, Record<string, PackageCompatibility>> = {
  '@arcanea-flow/cli': {
    '@arcanea-flow/embeddings': { minVersion: '3.0.0-alpha.1' },
    '@arcanea-flow/security': { minVersion: '3.0.0-alpha.1' },
    '@arcanea-flow/integration': { minVersion: '3.0.0-alpha.1' },
  },
  '@arcanea-flow/embeddings': {
    '@arcanea-flow/cli': { minVersion: '3.0.0-alpha.50' },
  },
  '@arcanea-flow/integration': {
    '@arcanea-flow/cli': { minVersion: '3.0.0-alpha.70' },
