...
async function main() {
  ...
  if (failed === 0) {
    ...
    console.log('    npx @arcanea-flow/cli patterns list');
    console.log('    npx @arcanea-flow/cli patterns list --featured');
    console.log('    npx @arcanea-flow/cli patterns search -q "agent"');
    console.log('    npx @arcanea-flow/cli patterns info -n <pattern-id>');
    console.log('');
  }
