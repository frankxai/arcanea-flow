...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/swarm.svg)](https://www.npmjs.com/package/@arcanea-flow/swarm)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/swarm.svg)](https://www.npmjs.com/package/@arcanea-flow/swarm)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![ADR-003](https://img.shields.io/badge/ADR--003-Compliant-green.svg)](https://github.com/ruvnet/arcanea-flow)
[![Agents](https://img.shields.io/badge/Agents-Up%20to%20100+-orange.svg)](https://github.com/ruvnet/arcanea-flow)
...
```typescript
import { createSwarmHub } from '@arcanea-flow/swarm';
...
```typescript
import { createQueenCoordinator } from '@arcanea-flow/swarm';
...
```typescript
import { createAttentionCoordinator } from '@arcanea-flow/swarm';
...
```typescript
import { createFederationHub, getDefaultFederationHub } from '@arcanea-flow/swarm';
