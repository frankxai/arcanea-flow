...
const STATE_FILE = join(process.cwd(), '.arcanea-flow', 'hooks-daemon.json');

async function main() {
  const daemonManager = new DaemonManager({
    pidDirectory: join(process.cwd(), '.arcanea-flow', 'pids'),
    logDirectory: join(process.cwd(), '.arcanea-flow', 'logs'),
    autoRestart: true,
