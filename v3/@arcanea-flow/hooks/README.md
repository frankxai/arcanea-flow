...
[![npm version](https://img.shields.io/npm/v/@arcanea-flow/hooks.svg)](https://www.npmjs.com/package/@arcanea-flow/hooks)
[![npm downloads](https://img.shields.io/npm/dm/@arcanea-flow/hooks.svg)](https://www.npmjs.com/package/@arcanea-flow/hooks)
...
The `@arcanea-flow/hooks` package provides a comprehensive hooks system for intercepting and extending Claude Flow operations. It enables intelligent task routing, pattern learning, background metrics collection, and real-time statusline integration.
...
# Using pnpm
pnpm add @arcanea-flow/hooks

# Using yarn
yarn add @arcanea-flow/hooks
```
...
```typescript
import { initializeHooks } from '@arcanea-flow/hooks';
...
```typescript
import { hooksMCPTools, getHooksTool } from '@arcanea-flow/hooks';
...
arcanea-flow hooks worker detect --prompt "deep dive into auth" --auto-dispatch --min-confidence 0.6
...
- [@arcanea-flow/shared](../shared) - Shared utilities and types
- [@arcanea-flow/neural](../neural) - Neural network and SONA learning
- [@arcanea-flow/swarm](../swarm) - Multi-agent coordination
- [@arcanea-flow/memory](../memory) - AgentDB memory system

## License

MIT © [Claude Flow Team](https://github.com/ruvnet/arcanea-flow)
