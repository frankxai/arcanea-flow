...
cp -r /path/to/arcanea-flow/v3/helpers/ your-project/.claude/helpers/
...
# Copy helpers
cp -r /path/to/arcanea-flow/v3/helpers/* .claude/helpers/
...
# Validate setup
./.claude/helpers/arcanea-flow-v3.sh validate
```
...
# Validate setup
.\.claude\helpers\arcanea-flow-v3.ps1 validate
```
...
```bash
# Linux/macOS
./.claude/helpers/arcanea-flow-v3.sh platform-info
./.claude/helpers/arcanea-flow-v3.sh status

# Windows
.\.claude\helpers\arcanea-flow-v3.ps1 platform-info
...
./.claude/helpers/arcanea-flow-v3.sh --version
