...
**Official Plugins:**
1. `@arcanea-flow/hive-mind` - Queen-led coordination
2. `@arcanea-flow/neural` - Neural training system
3. `@arcanea-flow/verification` - Truth scoring
4. `@arcanea-flow/enterprise` - Advanced features
