...
ADR-003 mandates a **single canonical coordination engine** for arcanea-flow v3. This document tracks the implementation of consolidating `UnifiedSwarmCoordinator` + `SwarmHub` into a unified approach.
...
**Location**: `/workspaces/arcanea-flow/v3/@arcanea-flow/swarm/src/unified-coordinator.ts`
...
**Location**: `/workspaces/arcanea-flow/v3/@arcanea-flow/swarm/src/coordination/swarm-hub.ts`
...
**Location**: `/workspaces/arcanea-flow/v3/coordination/swarm-hub.ts`
 ...
 * /workspaces/arcanea-flow/v3/@arcanea-flow/swarm/src/coordination/swarm-hub.ts
 */
```
