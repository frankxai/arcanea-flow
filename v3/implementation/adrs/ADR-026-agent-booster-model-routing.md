...
```typescript
// v3/@arcanea-flow/cli/src/ruvector/model-router.ts
...
```typescript
// v3/@arcanea-flow/cli/src/commands/hooks.ts (update preTaskCommand)
...
```typescript
// v3/@arcanea-flow/cli/src/mcp-tools/agent-tools.ts (update determineAgentModel)
