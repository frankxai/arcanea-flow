...
|---------|---------|------------|
| `npx @arcanea-flow/cli@alpha` | v3.0.0-alpha.87 | **171 tools**, 19 categories |
| `npx arcanea-flow@v3alpha` | v3.0.0-alpha.34 | **171 tools**, 19 categories |
...
| ADR-004 | Plugin Architecture | ✅ Complete | @arcanea-flow/plugins |
...
| ADR | Title | Status | Notes |
|-----|-------|--------|-------|
| ADR-011 | LLM Provider System | ✅ Complete | @arcanea-flow/providers |
...
| ADR-019 | Headless Runtime Package | ✅ Complete | @arcanea-flow/headless for CI/CD |
...
|---------|---------|-----------|
| @arcanea-flow/cli | **3.0.0-alpha.117** | 2026-01-14 |
| arcanea-flow | **3.0.0-alpha.76** | 2026-01-14 |
| @arcanea-flow/memory | 3.0.0-alpha.2 | 2026-01-07 |
| @arcanea-flow/mcp | 3.0.0-alpha.8 | 2026-01-07 |
| @arcanea-flow/neural | 3.0.0-alpha.2 | 2026-01-06 |
| @arcanea-flow/security | 3.0.0-alpha.1 | 2026-01-05 |
| @arcanea-flow/swarm | 3.0.0-alpha.1 | 2026-01-04 |
| @arcanea-flow/hooks | 3.0.0-alpha.2 | 2026-01-06 |
| @arcanea-flow/plugins | 3.0.0-alpha.2 | 2026-01-06 |
| @arcanea-flow/providers | 3.0.0-alpha.1 | 2026-01-04 |
| @arcanea-flow/embeddings | 3.0.0-alpha.12 | 2026-01-05 |
| @arcanea-flow/shared | 3.0.0-alpha.1 | 2026-01-03 |
...
|---------|---------|--------|
| @arcanea-flow/cli | 3.0.0, 3.0.1, 3.0.2 | Buggy early releases - use alpha.86+ |
...
|---------|---------|-----------|--------|
| @arcanea-flow/cli | **3.0.0-alpha.87** | 2026-01-13 | ✅ Beta Ready |
| arcanea-flow | **3.0.0-alpha.34** | 2026-01-13 | ✅ Beta Ready |
| @arcanea-flow/memory | 3.0.0-alpha.2 | 2026-01-07 | ✅ |
| @arcanea-flow/mcp | 3.0.0-alpha.8 | 2026-01-07 | ✅ |
| @arcanea-flow/neural | 3.0.0-alpha.2 | 2026-01-06 | ✅ |
| @arcanea-flow/security | 3.0.0-alpha.1 | 2026-01-05 | ✅ |
...
```bash
npx @arcanea-flow/cli@latest hooks statusline           # Full colored output
npx @arcanea-flow/cli@latest hooks statusline --json    # JSON format
npx @arcanea-flow/cli@latest hooks statusline --compact # Single-line format
```
...
output.writeln(output.dim('Run "npm audit" or "arcanea-flow security scan" for real vulnerability detection.'));
```
...
**Problem:** `npx arcanea-flow@alpha mcp start` failed with "Cannot read properties of undefined (reading 'split')"

**Root Cause:** npm resolved `^3.0.0-alpha.84` to buggy version `3.0.2` (semver: `3.0.2 > 3.0.0-alpha.84`)

**Solution:**
1. Pinned exact version in wrapper: `"@arcanea-flow/cli": "3.0.0-alpha.86"` (no caret)
2. Deprecated buggy versions: 3.0.0, 3.0.1, 3.0.2
3. Published arcanea-flow@3.0.0-alpha.33 with fix
...
- Provides fix command: `rm -rf ~/.npm/_npx/* && npx -y @arcanea-flow/cli@latest`

```bash
# Check version freshness
npx @arcanea-flow/cli@alpha doctor -c version

# Example output when outdated:
⚠ Version Freshness: v3.0.0-alpha.84 (latest: v3.0.0-alpha.86) [npx cache stale]
  Fix: rm -rf ~/.npm/_npx/* && npx -y @arcanea-flow/cli@latest
```
...
npx arcanea-flow update clear-cache # Clear check cache
```
...
| neural-tools.ts | ✅ File-based | ✅ **REAL** | Real embeddings via @arcanea-flow/embeddings |
...
- `neural/predict` - **REAL**: embeddings via @arcanea-flow/embeddings (agentic-flow)
...
- File-based persistence in `.arcanea-flow/` directory
...
- **Neural training**: Use `@arcanea-flow/neural` module
