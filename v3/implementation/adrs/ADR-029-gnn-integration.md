...
```typescript
// v3/@arcanea-flow/gnn/src/layers/gcn.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/layers/gat.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/layers/graphsage.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/layers/mpnn.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/layers/edge-conv.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/data/node-embeddings.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/data/edge-features.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/data/graph-representation.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/use-cases/codebase-graph.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/use-cases/agent-graph.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/use-cases/pattern-propagation.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/use-cases/impact-analysis.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/integration/memory-integration.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/integration/plugin-graph.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/integration/swarm-optimization.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/utils/sparse.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/utils/batching.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/utils/gpu.ts
...
```typescript
// v3/@arcanea-flow/gnn/src/types/index.ts
