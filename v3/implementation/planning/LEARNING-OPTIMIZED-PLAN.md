...
npx arcanea-flow install learning:basic
...
npx arcanea-flow install learning
...
npx arcanea-flow install learning:advanced
...
npx arcanea-flow install learning:advanced --native
...
npx arcanea-flow install learning:advanced --wasm
...
npx arcanea-flow learning start --algorithm q-learning
```
...
npm install arcanea-flow@3
npx arcanea-flow install memory learning

# Initialize with sensible defaults
npx arcanea-flow init --learning
```
...
npm install arcanea-flow@3
npx arcanea-flow install --all --native

# Configure for production
cat > .arcanea-flow/config.json << 'EOF'
{
  "learning": {
    "tier": "advanced",
    "nightly": {
...
npm install arcanea-flow@3
npx arcanea-flow install learning:basic --wasm

# Run tests with learning
npx arcanea-flow test --with-learning
```
...
npx arcanea-flow install learning --upgrade

# Upgrade from standard to advanced
npx arcanea-flow install learning:advanced --upgrade

# Downgrade (preserves data)
npx arcanea-flow install learning:basic --downgrade
```
...
npx arcanea-flow learning export --output learning-backup.json

# Import after upgrade
npx arcanea-flow learning import --input learning-backup.json

# Verify data integrity
npx arcanea-flow learning verify
```
...
npx arcanea-flow learning status

# View component load times
npx arcanea-flow learning diagnostics

# Test RL algorithms
npx arcanea-flow learning test --algorithm ppo

# Verify installation
npx arcanea-flow verify --component learning
```
