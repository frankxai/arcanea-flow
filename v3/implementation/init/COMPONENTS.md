...
### Core Commands
- `arcanea-flow-help.md` - Help documentation
- `arcanea-flow-swarm.md` - Swarm operations
- `arcanea-flow-memory.md` - Memory operations
...
```json
{
  "mcpServers": {
    "arcanea-flow": {
      "command": "npx",
      "args": ["@arcanea-flow/cli", "mcp", "start"],
      "env": {
        "CLAUDE_FLOW_MODE": "v3",
...
`.arcanea-flow/config.yaml` configures V3 runtime.
