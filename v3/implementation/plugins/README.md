...
```typescript
import { ClaudeFlowPlugin, PluginContext } from '@arcanea-flow/shared';
...
Located in `@arcanea-flow/shared/src/plugins/official/`:
...
```typescript
import { PluginError, PluginErrorCode } from '@arcanea-flow/shared';
